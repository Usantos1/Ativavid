...
Só o cenário D usa isto. A regra que ele existe para garantir: o Whisper é a
ÚNICA fonte de verdade temporal, e o Gemini só corrige conteúdo textual. Como
a legenda karaokê lê `Palavra.inicio`/`fim` direto (ver
`app/transcricao/__init__.py`), qualquer tempo inventado aqui aparece na tela.
