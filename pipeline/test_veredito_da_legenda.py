...
def test_o_save_devolve_o_veredito_no_corpo():
    ...
    # Ate o fim do handler, nao uma janela fixa: a 4.28 acrescentou 12
    # linhas aqui (o preset do video) e a janela de 4600 passou a cortar
    # antes do trecho medido — o teste acusava sem defeito.
    fim = src.find(chr(10) + "    def ", i)
    trecho = src[i:fim if fim > i else i + 8000]
